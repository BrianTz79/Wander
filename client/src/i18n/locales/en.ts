...
export const en: Catalogo = {
  ...
  navbar: {
    ...
    actividad: 'Activity',
    mensajes: 'Messages',
    mensajesSinLeer_one: '{{count}} unread conversation',
    mensajesSinLeer_other: '{{count}} unread conversations',
  ...
  social: {
    ...
    publicacion: 'Post',
    publicacionNoExiste: 'This post does not exist or was deleted.',
  ...
  notificaciones: {
    ...
    abrir: 'Open notifications',
    abrirConPendientes_one: 'Open notifications ({{count}} unread)',
    abrirConPendientes_other: 'Open notifications ({{count}} unread)',
    vacio: 'They will show up here when someone interacts with you.',
    verTodas: 'See all',
    alguien: 'Someone',
    teSiguio: '{{quien}} started following you',
    comentoTuPublicacion: '{{quien}} commented on your post',
    comentoTuPerfil: '{{quien}} posted on your profile',
    reacciono: '{{quien}} liked your post',
    teEscribio: '{{quien}} sent you a message',
    teInvito: '{{quien}} added you to a group',
    teMenciono: '{{quien}} mentioned you',
    sistema: 'Wander notice',
  },
  ...
  mensajes: {
    ...
    bandejaVacia: 'You do not have any conversations yet.',
    sinSolicitudes: 'No pending requests.',
    eligeConversacion: 'Pick a conversation to start reading.',
    sinNombre: 'Conversation',
    sinMensajes: 'No messages yet',
    hiloVacio: 'Write the first message.',
    escribeUnMensaje: 'Write a message…',
    enviar: 'Send',
    editado: 'edited',
    borrado: 'Message deleted',
    estaEscribiendo: '{{quien}} is typing…',
    participantes_one: '{{count}} participant',
    participantes_other: '{{count}} participants',
    silenciar: 'Mute conversation',
    activarAvisos: 'Unmute',
    salirGrupo: 'Leave group',
    confirmarSalir: 'Are you sure you want to leave this group?',
    noSePudoCargar: 'The conversation could not be loaded.',
    noExiste: 'This conversation does not exist.',
    esSolicitud:
      'This person messaged you for the first time. If you accept, the conversation moves to your inbox.',
    aceptar: 'Accept',
    enviarMensaje: 'Send message',
    mensaje: 'Message',
    noSePudoAbrir: 'Could not open the conversation.',

    // ── Starting a conversation (Phase 10) ──
    nuevaConversacion: 'New conversation',
    nuevoGrupo: 'New group',
    buscarPersonas: 'Search by name or @handle…',
    sinResultados: 'Nobody matches that search.',
    nombreDelGrupo: 'Group name',
    crearGrupo: 'Create group',
    elegidas_one: '{{count}} person selected',
    elegidas_other: '{{count}} people selected',
    quitar: 'Remove',
    faltaNombre: 'Give the group a name.',
    faltaGente: 'Pick at least one person.',
    cancelar: 'Cancel',
    'evento.participante-anadido': '{{quien}} added {{objetivo}}',
    'evento.participante-quitado': '{{quien}} removed {{objetivo}}',
    'evento.participante-salio': '{{objetivo}} left the group',
  },

  // ── Composer: emoji, GIFs and attachments (Phase 8) ────────────────
  compositor: {
    emojis: 'Emoji',
    gifs: 'Search GIFs',
    buscarGifs: 'Search GIFs…',
    sinGifs: 'No GIFs found.',
    viaGiphy: 'GIFs via GIPHY',
    adjuntar: 'Attach file',
    quitarAdjunto: 'Remove file',
    archivo: 'File',
    video: 'Video',
